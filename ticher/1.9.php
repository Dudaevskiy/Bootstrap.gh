...
<head>
	...
	<!------------------------------
	Подключение кастомизированного стиля BootStrap
	------------------------------->
	<!-- Bootstrap my costum -->
...
<br> Для подключения <a href="http://dedushka.org/tag/sass" target="_blank">SASS</a> необходимо произвести данные настройки <br>
<img style="width:550px;" src="\ticher\Koala_settings.png" alt="">
<br><a href="http://dedushka.org/soft/8814.html" target="_blank"> <b>Узнать о настройках koala можно здесь</b></a>
<br></p>
